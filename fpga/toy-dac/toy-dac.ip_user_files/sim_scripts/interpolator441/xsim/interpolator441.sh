...
#
# Script generated by Vivado on Sat Apr 11 12:38:40 -0400 2026
# SW Build 5239630 on Fri Nov 08 22:35:27 MST 2024
#
# Copyright 1986-2022 Xilinx, Inc. All Rights Reserved.
# Copyright 2022-2024 Advanced Micro Devices, Inc. All Rights Reserved. 
#
# Filename     : interpolator441.sh
...
#
# Usage        : interpolator441.sh
#                interpolator441.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                interpolator441.sh [-reset_run]
#                interpolator441.sh [-reset_log]
#                interpolator441.sh [-help]
#
...
# script info
echo -e "interpolator441.sh - Script generated by export_simulation (Vivado v2024.2 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./interpolator441.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 2  -L xil_defaultlib -L xbip_utils_v3_0_14 -L axi_utils_v2_0_10 -L fir_compiler_v7_2_23 -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot interpolator441 xil_defaultlib.interpolator441 xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim interpolator441 -key {Behavioral:sim_1:Functional:interpolator441} -tclbatch cmd.tcl -log simulate.log
}
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb interpolator441.wdb xsim.dir libdpi.so)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./interpolator441.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: interpolator441.sh [-help]\n\
Usage: interpolator441.sh [-step]\n\
Usage: interpolator441.sh [-lib_map_path]\n\
Usage: interpolator441.sh [-reset_run]\n\
Usage: interpolator441.sh [-reset_log]\n\
Usage: interpolator441.sh [-keep_index]\n\
Usage: interpolator441.sh [-noclean_files]\n\n\
