...
#
# Script generated by Vivado on Fri May 01 08:45:51 -0400 2026
...
#
# Usage        : clock.sh
#                clock.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                clock.sh [-reset_run]
#                clock.sh [-reset_log]
#                clock.sh [-help]
#
...
# script info
echo -e "clock.sh - Script generated by export_simulation (Vivado v2024.2 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./clock.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 2  -L xil_defaultlib -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot clock xil_defaultlib.clock xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim clock -key {Behavioral:sim_1:Functional:clock} -tclbatch cmd.tcl -log simulate.log
}
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb clock.wdb xsim.dir libdpi.so)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./clock.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: clock.sh [-help]\n\
Usage: clock.sh [-step]\n\
Usage: clock.sh [-lib_map_path]\n\
Usage: clock.sh [-reset_run]\n\
Usage: clock.sh [-reset_log]\n\
Usage: clock.sh [-keep_index]\n\
Usage: clock.sh [-noclean_files]\n\n\
