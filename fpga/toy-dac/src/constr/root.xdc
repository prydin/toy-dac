...
# (currently 4). Hold registers inside each DAC sample input/dither on the same
...
set_multicycle_path -setup 4 -from $dac_slow_from -to $dac_slow_to
set_multicycle_path -hold  3 -from $dac_slow_from -to $dac_slow_to
